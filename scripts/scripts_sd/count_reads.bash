...
Rscript ${SRC}/scripts_sd/count_transcripts.R ${FLDG}StarDust.bam ${FLDG}StarDust.gtf transcript gene_id ${FLDG}StarDust FALSE &>> ${FLDG}StarDust.log
if [ "$HIS" != "NA" ]; then
 ...
 samtools cat -o ${FLDG}StarDust_splicing_temp.bam ${FLD4}DONE_uniq_k500.BAM ${FLD4}DONE_multiple_k500.BAM &>> ${FLDG}StarDust.log
 ...
 Rscript ${SRC}/scripts_sd/count_transcripts.R ${FLDG}StarDust_splicing.bam ${FLDG}StarDust.gtf transcript gene_id ${FLDG}StarDust_splicing TRUE &>> ${FLDG}StarDust.log
